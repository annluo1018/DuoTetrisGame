var Local = function (socket) {
  ...
  var move = function () {
    ...
    if (!game.down()) {
      ...
      if (gameOver) {
        ...
        document.getElementById('remote_gameover').innerHTML = 'Win (^_^)∠※';
        socket.emit('lose');
        stop();
      } else {
  ...
  socket.on('start', function() {
    ...
    var timer = setInterval(function () {
      if (onlineStatus) {
        ...
        document.getElementById('mask_title').innerHTML = 'The other player lost connection<a href="javascript:;" onclick="location.reload()">[Re-match]</a>';
  ...
  socket.on('leave', function() {
    document.getElementById('local_gameover').innerHTML = 'The other player lost connection';
